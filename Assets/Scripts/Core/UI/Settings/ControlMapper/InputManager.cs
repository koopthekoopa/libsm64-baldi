...
public class InputManager : Singleton<InputManager>
{
    ...
    private InputBinding GetDefaultBinding(InputAction action)
    {
        switch (action)
        {
            ...
            case InputAction.Interact: return new InputBinding(KeyCode.None);
            case InputAction.UseItem: return new InputBinding(KeyCode.Q);
            ...
            case InputAction.Punch: return new InputBinding(KeyCode.LeftShift, KeyCode.Mouse1);
            case InputAction.Crouch: return new InputBinding(KeyCode.LeftControl);
            case InputAction.Jump: return new InputBinding(KeyCode.Space, KeyCode.Mouse0);
